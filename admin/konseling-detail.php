                ...
                <div class="row my-5">
                    ...
                    <div class="table-comp">
                        ...
                        <thead>
                            ...
                            <th scope="col" class="col-md-4">Media Konseling</th>
                            <th scope="col" class="col-md-4">Nama Bayi</th>
                            <th scope="col" class="col-md-4">Usia Bayi Saat Ini</th>
                            <th scope="col" class="col-md-4">Bayi Anak Ke</th>
                            <th scope="col" class="col-md-4">Usia Kehamilan Saat Bayi Lahir</th>
                            <th scope="col" class="col-md-4">Proses Kelahiran</th>
                            ...
                            <th scope="col" class="col-md-4">Jika ya, sebutkan. jawab (-) jika tidak</th>
                            ...
                            <th scope="col" class="col-md-4">Apakah Sebelumnya Sudah Pernah Berkonsultasi Dengan Konselor Menyusui atau Konsultan Laktasi?</th>
                            <th scope="col" class="col-md-4">Apakah Selama Kehamilan Sudah Mengikuti Kelas Persiapan Menyusui atau Konseling Persiapan Menyusui?</th>
                            ...
                            <th scope="col" class="col-md-4">Apakah dirumah ibu mendapatkan bantuan dari suami atau anggota keluarga lain dalam merawat bayi/mengurus rumah/mengurus anak yang lebih tua jika ada?</th>
                            <th scope="col" class="col-md-4">Apakah suami dan keluarga mendukung ibu untuk menyusui atau pemberian MPASI yang tepat sesuai anjuran?</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
                            ...
                            <td class="col-md-2">Jl. Tanjung 4 Taman Century 2, Blok L No.5, RT 003/RW 023, Kec. Bekasi Selatan, Kel. Pekayon Jaya, Bekasi</td>
                            <td>081288746848</td>
